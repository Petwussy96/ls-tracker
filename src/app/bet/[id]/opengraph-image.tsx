...
export default async function Image({ params }: { params: { id: string } }) {
  ...
  const totalLegs = await prisma.selection.count({ where: { betId: bet.id } });
  ...
  const roleEmoji = bet.user.role === "admin" ? "👑" : bet.user.role === "moderator" ? "🛡️" : "";
